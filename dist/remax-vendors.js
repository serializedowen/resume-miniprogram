...
var defaultRuntimeOptions = {
  ...
  appEvents: [],
  pageEvents: {},
  pluginDriver: new _PluginDriver__WEBPACK_IMPORTED_MODULE_1__["default"]([]),
  history: {}
};
var runtimeOptions = defaultRuntimeOptions;
function apply(options) {
  runtimeOptions = lodash_merge__WEBPACK_IMPORTED_MODULE_0___default()(runtimeOptions, options);
}
function get(key) {
